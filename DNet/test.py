...
parser.add_argument("--imagePath", help="Put the absolute path of the image")
parser.add_argument("--depthPath", help="Put the absolute path to save the depth numpy")
args = parser.parse_args()
print(args.imagePath)
absoluteDepth(args.imagePath, args.depthPath)
